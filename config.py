...
POSITION_SIZING_MODE = os.getenv("POSITION_SIZING_MODE", "risk").strip().lower() or "risk"
POSITION_MARGIN_ALLOCATION_PCT = _get_float("POSITION_MARGIN_ALLOCATION_PCT", 25.0)
