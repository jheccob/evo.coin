...
ENABLE_MOMENTUM_BREAKOUT_LONG = _get_bool("ENABLE_MOMENTUM_BREAKOUT_LONG", True)
MOMENTUM_BREAKOUT_LOOKBACK = _get_int("MOMENTUM_BREAKOUT_LOOKBACK", 32)
MOMENTUM_BREAKOUT_MIN_BREAK_PCT = _get_float("MOMENTUM_BREAKOUT_MIN_BREAK_PCT", 0.18)
MOMENTUM_BREAKOUT_MAX_EXTENSION_FAST_EMA_PCT = _get_float("MOMENTUM_BREAKOUT_MAX_EXTENSION_FAST_EMA_PCT", 1.75)
MOMENTUM_BREAKOUT_MIN_VOLUME_RATIO = _get_float("MOMENTUM_BREAKOUT_MIN_VOLUME_RATIO", 2.0)
MOMENTUM_BREAKOUT_FOLLOWUP_MIN_VOLUME_RATIO = _get_float("MOMENTUM_BREAKOUT_FOLLOWUP_MIN_VOLUME_RATIO", 0.85)
MOMENTUM_BREAKOUT_MIN_TREND_STRENGTH_PCT = _get_float("MOMENTUM_BREAKOUT_MIN_TREND_STRENGTH_PCT", 0.15)
MOMENTUM_BREAKOUT_MIN_CONTEXT_GAP_PCT = _get_float("MOMENTUM_BREAKOUT_MIN_CONTEXT_GAP_PCT", 0.40)
MOMENTUM_BREAKOUT_ALLOW_EARLY_BREAKOUT = _get_bool("MOMENTUM_BREAKOUT_ALLOW_EARLY_BREAKOUT", False)
MOMENTUM_BREAKOUT_ALLOW_FOLLOWUP_VOLUME = _get_bool("MOMENTUM_BREAKOUT_ALLOW_FOLLOWUP_VOLUME", False)
MOMENTUM_BREAKOUT_MIN_RSI = _get_float("MOMENTUM_BREAKOUT_MIN_RSI", 75.0)
MOMENTUM_BREAKOUT_MAX_RSI = _get_float("MOMENTUM_BREAKOUT_MAX_RSI", 88.0)
MOMENTUM_BREAKOUT_MIN_ADX = _get_float("MOMENTUM_BREAKOUT_MIN_ADX", 24.0)
MOMENTUM_BREAKOUT_MAX_ADX = _get_float("MOMENTUM_BREAKOUT_MAX_ADX", 45.0)
MOMENTUM_BREAKOUT_MAX_TREND_STRENGTH_PCT = _get_float("MOMENTUM_BREAKOUT_MAX_TREND_STRENGTH_PCT", 0.60)
MOMENTUM_BREAKOUT_REQUIRE_MACD_IMPROVING = _get_bool("MOMENTUM_BREAKOUT_REQUIRE_MACD_IMPROVING", True)
MOMENTUM_BREAKOUT_MIN_SCORE = _get_int("MOMENTUM_BREAKOUT_MIN_SCORE", 9)
...
PULLBACK_LONG_MIN_ADX = _get_float("PULLBACK_LONG_MIN_ADX", 45.0)
PULLBACK_LONG_MAX_CONTEXT_GAP_PCT = _get_float("PULLBACK_LONG_MAX_CONTEXT_GAP_PCT", 0.9)
PULLBACK_LONG_MIN_RSI = _get_float("PULLBACK_LONG_MIN_RSI", 52.0)
...
TREND_RESUME_LONG_MIN_CONTEXT_GAP_PCT = _get_float("TREND_RESUME_LONG_MIN_CONTEXT_GAP_PCT", 0.90)
TREND_RESUME_LONG_MAX_CONTEXT_GAP_PCT = _get_float("TREND_RESUME_LONG_MAX_CONTEXT_GAP_PCT", 0.0)
TREND_RESUME_LONG_MIN_ADX = _get_float("TREND_RESUME_LONG_MIN_ADX", 40.0)
...
MOMENTUM_BREAKOUT_LONG_STOP_LOSS_PCT = _get_float("MOMENTUM_BREAKOUT_LONG_STOP_LOSS_PCT", 1.2)
MOMENTUM_BREAKOUT_LONG_PARTIAL_TARGET_PCT = _get_float("MOMENTUM_BREAKOUT_LONG_PARTIAL_TARGET_PCT", 1.0)
MOMENTUM_BREAKOUT_LONG_TRAILING_TRIGGER_PCT = _get_float(
    "MOMENTUM_BREAKOUT_LONG_TRAILING_TRIGGER_PCT",
    1.2,
)
MOMENTUM_BREAKOUT_LONG_TRAILING_STOP_PCT = _get_float(
    "MOMENTUM_BREAKOUT_LONG_TRAILING_STOP_PCT",
    0.55,
)
MOMENTUM_BREAKOUT_LONG_USE_FIXED_STOP = _get_bool("MOMENTUM_BREAKOUT_LONG_USE_FIXED_STOP", False)
...
TREND_RESUME_SHORT_MAX_CONTEXT_GAP_PCT = _get_float("TREND_RESUME_SHORT_MAX_CONTEXT_GAP_PCT", 0.0)
TREND_RESUME_SHORT_MAX_ADX = _get_float("TREND_RESUME_SHORT_MAX_ADX", 46.0)
TREND_RESUME_SHORT_MAX_TREND_STRENGTH_PCT = _get_float("TREND_RESUME_SHORT_MAX_TREND_STRENGTH_PCT", 0.7)
...
PULLBACK_LONG_STOP_LOSS_PCT = _get_float("PULLBACK_LONG_STOP_LOSS_PCT", 1.4)
...
LONG_REVERSAL_MAX_RSI = _get_float("LONG_REVERSAL_MAX_RSI", 56.0)
...
LONG_REVERSAL_MIN_SCORE = _get_int("LONG_REVERSAL_MIN_SCORE", 7)
LONG_REVERSAL_STOP_LOSS_PCT = _get_float("LONG_REVERSAL_STOP_LOSS_PCT", 1.0)
...
SHORT_REVERSAL_MAX_RSI = _get_float("SHORT_REVERSAL_MAX_RSI", 54.0)
...
SHORT_REVERSAL_BLOCKED_ENTRY_HOURS_UTC = _get_int_list("SHORT_REVERSAL_BLOCKED_ENTRY_HOURS_UTC", [])
SHORT_REVERSAL_REQUIRE_MACD_WORSENING = _get_bool("SHORT_REVERSAL_REQUIRE_MACD_WORSENING", True)
SHORT_REVERSAL_MIN_SCORE = _get_int("SHORT_REVERSAL_MIN_SCORE", 6)
...
# Filtro operacional por horario. Em producao, a calibracao agora prioriza
# contexto/estrutura dos setups em vez de bloquear janelas fixas do dia.
...
def build_runtime_strategy_snapshot(context_timeframe: Optional[str] = None) -> Dict[str, object]:
    ...
    return {
        ...
        "enable_momentum_breakout_long": bool(ENABLE_MOMENTUM_BREAKOUT_LONG),
        "momentum_breakout_lookback": int(MOMENTUM_BREAKOUT_LOOKBACK),
        "momentum_breakout_min_break_pct": float(MOMENTUM_BREAKOUT_MIN_BREAK_PCT),
        "momentum_breakout_max_extension_fast_ema_pct": float(
            MOMENTUM_BREAKOUT_MAX_EXTENSION_FAST_EMA_PCT
        ),
        "momentum_breakout_min_volume_ratio": float(MOMENTUM_BREAKOUT_MIN_VOLUME_RATIO),
        "momentum_breakout_followup_min_volume_ratio": float(
            MOMENTUM_BREAKOUT_FOLLOWUP_MIN_VOLUME_RATIO
        ),
        "momentum_breakout_min_trend_strength_pct": float(MOMENTUM_BREAKOUT_MIN_TREND_STRENGTH_PCT),
        "momentum_breakout_min_context_gap_pct": float(MOMENTUM_BREAKOUT_MIN_CONTEXT_GAP_PCT),
        "momentum_breakout_allow_early_breakout": bool(MOMENTUM_BREAKOUT_ALLOW_EARLY_BREAKOUT),
        "momentum_breakout_allow_followup_volume": bool(MOMENTUM_BREAKOUT_ALLOW_FOLLOWUP_VOLUME),
        "momentum_breakout_min_rsi": float(MOMENTUM_BREAKOUT_MIN_RSI),
        "momentum_breakout_max_rsi": float(MOMENTUM_BREAKOUT_MAX_RSI),
        "momentum_breakout_min_adx": float(MOMENTUM_BREAKOUT_MIN_ADX),
        "momentum_breakout_max_adx": float(MOMENTUM_BREAKOUT_MAX_ADX),
        "momentum_breakout_max_trend_strength_pct": float(MOMENTUM_BREAKOUT_MAX_TREND_STRENGTH_PCT),
        "momentum_breakout_require_macd_improving": bool(MOMENTUM_BREAKOUT_REQUIRE_MACD_IMPROVING),
        "momentum_breakout_min_score": int(MOMENTUM_BREAKOUT_MIN_SCORE),
        ...
        "momentum_breakout_long_stop_loss_pct": float(MOMENTUM_BREAKOUT_LONG_STOP_LOSS_PCT),
        "momentum_breakout_long_partial_target_pct": float(MOMENTUM_BREAKOUT_LONG_PARTIAL_TARGET_PCT),
        "momentum_breakout_long_trailing_trigger_pct": float(
            MOMENTUM_BREAKOUT_LONG_TRAILING_TRIGGER_PCT
        ),
        "momentum_breakout_long_trailing_stop_pct": float(MOMENTUM_BREAKOUT_LONG_TRAILING_STOP_PCT),
        "momentum_breakout_long_use_fixed_stop": bool(MOMENTUM_BREAKOUT_LONG_USE_FIXED_STOP),
        ...
        "trend_resume_short_max_context_gap_pct": float(TREND_RESUME_SHORT_MAX_CONTEXT_GAP_PCT),
        "trend_resume_short_max_adx": float(TREND_RESUME_SHORT_MAX_ADX),
        "trend_resume_short_max_trend_strength_pct": float(TREND_RESUME_SHORT_MAX_TREND_STRENGTH_PCT),
...
SYMBOL_STRATEGY_OVERRIDE_KEYS = [
    ...
    "ENABLE_MOMENTUM_BREAKOUT_LONG",
    "MOMENTUM_BREAKOUT_LOOKBACK",
    "MOMENTUM_BREAKOUT_MIN_BREAK_PCT",
    "MOMENTUM_BREAKOUT_MAX_EXTENSION_FAST_EMA_PCT",
    "MOMENTUM_BREAKOUT_MIN_VOLUME_RATIO",
    "MOMENTUM_BREAKOUT_FOLLOWUP_MIN_VOLUME_RATIO",
    "MOMENTUM_BREAKOUT_MIN_TREND_STRENGTH_PCT",
    "MOMENTUM_BREAKOUT_MIN_CONTEXT_GAP_PCT",
    "MOMENTUM_BREAKOUT_ALLOW_EARLY_BREAKOUT",
    "MOMENTUM_BREAKOUT_ALLOW_FOLLOWUP_VOLUME",
    "MOMENTUM_BREAKOUT_MIN_RSI",
    "MOMENTUM_BREAKOUT_MAX_RSI",
    "MOMENTUM_BREAKOUT_MIN_ADX",
    "MOMENTUM_BREAKOUT_MAX_ADX",
    "MOMENTUM_BREAKOUT_MAX_TREND_STRENGTH_PCT",
    "MOMENTUM_BREAKOUT_REQUIRE_MACD_IMPROVING",
    ...
    "MOMENTUM_BREAKOUT_LONG_STOP_LOSS_PCT",
    "MOMENTUM_BREAKOUT_LONG_PARTIAL_TARGET_PCT",
    "MOMENTUM_BREAKOUT_LONG_TRAILING_TRIGGER_PCT",
    "MOMENTUM_BREAKOUT_LONG_TRAILING_STOP_PCT",
    "MOMENTUM_BREAKOUT_LONG_USE_FIXED_STOP",
    ...
    "TREND_RESUME_SHORT_MAX_CONTEXT_GAP_PCT",
    "TREND_RESUME_SHORT_MAX_ADX",
    "TREND_RESUME_SHORT_MAX_TREND_STRENGTH_PCT",
    "TREND_RESUME_SHORT_REQUIRE_BREAKDOWN_CONFIRMATION",
    "TREND_RESUME_SHORT_BLOCKED_ENTRY_HOURS_UTC",
]
