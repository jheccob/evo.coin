...
LIQUIDITY_SWEEP_MAX_PULLBACK_FROM_HIGH_PCT = _get_float("LIQUIDITY_SWEEP_MAX_PULLBACK_FROM_HIGH_PCT", 4.0)
...
DISABLE_SHORT_SCORE_GATE = _get_bool("DISABLE_SHORT_SCORE_GATE", False)
