...
MOMENTUM_BREAKOUT_MIN_SCORE = _get_int("MOMENTUM_BREAKOUT_MIN_SCORE", 8)
...
MOMENTUM_BREAKOUT_LONG_STOP_LOSS_PCT = _get_float("MOMENTUM_BREAKOUT_LONG_STOP_LOSS_PCT", 1.35)
